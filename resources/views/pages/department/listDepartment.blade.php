        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>List of Departments Data Table</h5>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="text-center">{{ $departments->dept_code }}</td>
                                    <td>{{ $departments->dept_name }}</td>
                                    @if(!empty($departments->status))
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('department.view', $departments->id) }}" data-toggle="tooltip" data-placement="top" title="View">
                                            <span class="label label-success"><i class="fa fa-desktop"></i></span>
                                        </a>
                                        <a href="{{ route('department.update', $departments->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <span class="label label-warning"><i class="fa fa-pencil"></i></span>
                                        </a>
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="Delete">
                                            <span class="label label-danger" data-toggle="modal" data-target="#delete-{{ $departments->id }}"><i class="fa fa-trash"></i></span>
                                        </a>
                                    </td>
                                </tr>
                                {{-- Modal Delete Viewer --}}
                                <div class="modal inmodal" id="delete-{{ $departments->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content animated flipInY">
                                            ...
                                            <div class="modal-footer">
                                                {{ Form::open(['method' => 'post', 'route' => array('department.delete', $departments->id)]) }}
